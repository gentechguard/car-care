...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth" suppressHydrationWarning style={{ background: '#070604' }}>
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased bg-[#070604] text-white`}
