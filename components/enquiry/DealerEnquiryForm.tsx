...
import { DealerEnquiry } from '@/types/enquiries';
...
export default function DealerEnquiryForm({ onClose }: DealerEnquiryFormProps) {
  const [formData, setFormData] = useState<Partial<DealerEnquiry>>({
    products_interested: []
  });
  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-amber-950/30 via-black/60 to-black/80 backdrop-blur-xl border border-white/10">
      <div className="p-6 md:p-8">
        ...
        <div className="flex items-start justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-amber-300 text-xs uppercase tracking-widest font-bold mt-1">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <FormInput
            ...
            onChange={(val) => setFormData(prev => ({ ...prev, dealer_name: val }))}
          ...
          <FormInput
            ...
            onChange={(val) => setFormData(prev => ({ ...prev, studio_name: val }))}
            error={errors.studio_name}
            theme="orange"
            delay={0.1}
            placeholder="Enter studio/business name"
          />
